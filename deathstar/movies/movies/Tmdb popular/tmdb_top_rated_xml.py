...
site = "https://www.themoviedb.org/movie/top-rated"
        ...
        if html != False:
                                ...
                                if len(match2) != 0:
                                        ...
                                        if html3:
                                                ...
                                                if match3:
                                                        ...
                                                        f.write('\t</link>\n')
                                                        f.write('\t<animated_thumbnail></animated_thumbnail>\n')
                                                        f.write('\t<thumbnail>%s</thumbnail>\n' % icon)
                                                        f.write('\t<animated_fanart></animated_fanart>\n')
                ...
                if match:
                        ...
                        # Back Up Way To Pull Next Page
                                ...
                                regex = r'<p class="right pagination"><a href="(/movie/top-rated\?page=[1-9]*&language=en)"><span'
                                match = re.compile(regex).findall(html)
